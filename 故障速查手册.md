...
取消XX-NET根目录\data\gae_proxy\code\default\gae_proxy\local\cert_util.py代码内252行的注释（将代码开头的 “#”删除，然后保存）<br>
源码参见：https://github.com/XX-net/XX-Net/blob/master/code/default/gae_proxy/local/cert_util.py#L252<br>
然后删除XX-NET根目录\data\gae_proxy\下的 CA.crt和 certs ,重启 xx-net<br>
